/* Generated By:JJTree&JavaCC: Do not edit this line. CCGbankDerivationTokenManager.java */
package opennlp.ccgbank.parse;
import java.util.*;
import org.apache.tools.ant.Task;

public class CCGbankDerivationTokenManager implements CCGbankDerivationConstants
{
...
"", "\173", "\76", "\54", "\56", "\72", null, "\175", "\133", "\135", null, 
null, null, null, null, null, null, "\50", "\74\124", "\51", "\74\114", };
...
public CCGbankDerivationTokenManager(SimpleCharStream stream){
   if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
   input_stream = stream;
}
public CCGbankDerivationTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
