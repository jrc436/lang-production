...
/**
 * Rather than deprecated, this file was never completely finished
 * @author jrc436
 *
 */
@Deprecated
public class NgramScorer implements UnaryEvaluator {
	...
	public double score(String s) {
		return UnaryEvaluator.convertToProb(logProb(s, s.split(" ").length, false));
	}
