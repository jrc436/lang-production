...
public class IOSettings {
	...
	protected static final String trialSet = "ngram-baseline5"; //trialset refers to a single optimization run's name
	...
	protected static final double percentInput = 1.0;
