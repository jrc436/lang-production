...
//	}
	...
	protected void flushRetrieval() {
		effects.add(new FlushRetrieval());
	}
	...
	protected void changeGoal(String s, List<ISlot> removeEffects, boolean set) {
		if (!set) {
			effects.add(new ChangeGoalBuffer(s, removeEffects));
		}
		else {
			effects.add(new SetGoalBuffer(s));
		}
	}
