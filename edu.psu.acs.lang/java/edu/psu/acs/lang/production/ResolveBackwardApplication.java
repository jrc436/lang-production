...
public class ResolveBackwardApplication extends SyntaxRuleResolution {
	...
	public ResolveBackwardApplication() {
		super(SyntaxRuleType.BackwardApplication);
		...
		goalprecond.add(new Slot(new SSlotName(SSlotNameEnum.RightFullType), new SlotVar(type)));
