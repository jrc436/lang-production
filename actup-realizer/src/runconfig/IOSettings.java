...
public class IOSettings {
	...
	protected static final String trialSet = "climb-full"; //trialset refers to a single optimization run's name
	protected static final int iterCap = 10000; //number of iterations before it terminates
	protected static final int NumConcurrentStarts = 3; //should be roughly equal to number of processors
	...
	protected static final double percentInput = 0.10;
