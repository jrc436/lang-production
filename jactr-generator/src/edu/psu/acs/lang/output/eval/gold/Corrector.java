...
//
//public class MapProces {
//	private static List<GramSet> getInputMap(File[] fileList) throws IOException {
...
//		for (int i = 0; i < 50; i++) {
//			List<OutputSentence> os = OutputReader.getAllSentences(EvaluationConsts.getAllOutputFiles(i));
...
//		File[] fileList = EvaluationConsts.getGoldFilesList();
...
//			FileWriter fw = new FileWriter(EvaluationConsts.getFixedGoldFile(newNum));
