...
:- use_module(boxer(resolveDRT),[resolveDRS/4]).
...
ccg2drs([CCG|L],XDRS,Context):-  
   build(CCG,DRS,Tags,1,Index,_), 
   resolveDRS(DRS,[]-C,[]-P,Tags), !,
   incAttempted, incCompleted,
   ccg2drss(L,Tags,DRS,C,P,Context,XDRS,Index). 
...
ccg2drss([],Tags-[],PDRS,_,_,_,xdrs(Tags,Sem),_):- !,
   semantics(PDRS,Tags,Sem).

ccg2drss([CCG|L],Tags1-Tags2,PrevDRS,C1,P1,Context,XDRS,Index):-  
   build(CCG,DRS,Tags2-Tags3,Index,NewIndex,_), 
   insertDRS(PrevDRS,DRS,NewDRS),
   resolveDRS(DRS,C1-C2,P1-P2,Tags1-Tags3), !,
   incAttempted, incCompleted,
   ccg2drss(L,Tags1-Tags3,NewDRS,C2,P2,Context,XDRS,NewIndex). 

ccg2drss([CCG|L],Tags,PDRS,C,P,Context,XDRS,Index):-
   incAttempted,
   noanalysis(CCG), 
   ccg2drss(L,Tags,PDRS,C,P,Context,XDRS,Index). 
