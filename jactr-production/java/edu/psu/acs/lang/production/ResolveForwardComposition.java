...
public class ResolveForwardComposition extends SyntaxRuleResolution {
	public ResolveForwardComposition(int lexsynNum, int lexsynTypeNum, int maxwords, int maxTypes) {
		super(SyntaxRuleType.ForwardComposition, lexsynNum, lexsynTypeNum, maxwords, maxTypes);
		String right = "A";
		String left = "C";
		String rettype = "T";
		...
		goalprecond.add(new Slot(new SSlotName(SSlotNameEnum.LexsynCombo, lexsynNum, maxwords, lexsynTypeNum, maxTypes), new CCGOperator(CCGOperatorEnum.Slash)));
		...
		retprecond.add(new Slot(CCGTypeSlot.Combinator, new CCGOperator(CCGOperatorEnum.Slash)));
